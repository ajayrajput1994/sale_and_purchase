...
//	}
	...
	public String do_register(@ModelAttribute("regdata") User  user,@RequestParam(value="agreed",defaultValue="false") Boolean agreed,Model m,HttpSession session) {
		...
		try {
			...
			e.printStackTrace();
			  ...
			  m.addAttribute("regdata",user); session.setAttribute("message",new Message("Something went wrong!"+e.getMessage(),"alert-danger"));
	...
	public String doContact(@ModelAttribute("cantactdata") ContactUs  cantactdata,Model m,HttpSession session) {
		try {
			...
			boolean flag=this.mailService.sendEmail(cantactdata.getSubject(), cantactdata.getDescription(), cantactdata.getEmail());
			 if(flag)
				{
			...
			e.printStackTrace();
			  ...
			  m.addAttribute("cantactdata",cantactdata); session.setAttribute("message",new Message("Something went wrong!"+e.getMessage(),"alert-danger"));
