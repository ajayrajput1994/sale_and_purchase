...
public class AdminResController {
  ...
  public ResponseEntity<?> createCategory(
    ...
    return new ResponseEntity<>(
        responseData.jsonSimpleResponse("SUCCESS", "Successfuly " + action, action, mainCatService.addCategory(cat)),
  ...
  // "Successfuly Update", "UPDATE", cat),
  // HttpStatus.OK);
  // }
  // MainCategory category = mainCatService.CreateMainCategory(cat);
  // return new ResponseEntity<>(responseData.jsonSimpleResponse("SUCCESS",
  // "Successfuly Created", "CREATE", category),
  // HttpStatus.OK);
  // } catch (Exception ex) {
  ...
  public ResponseEntity<?> getCategoryById(@PathVariable("id") int id) {
    ...
    try {
      ...
      return new ResponseEntity<>(
          responseData.jsonSimpleResponse("SUCCESS", "Successfuly Loaded", "LOADED",
              mainCatService.getAllMainCategory()),
          HttpStatus.OK);
    } catch (Exception ex) {
      return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
    }
  ...
  public ResponseEntity<?> createSubCategory(
    ...
    return new ResponseEntity<>(
        responseData.jsonSimpleResponse("SUCCESS", "Successfuly " + action, action, subcatService.addSubCategory(sub)),
        action == "CREATE" ? HttpStatus.CREATED : HttpStatus.OK);

  }
  // @PostMapping("/sub-category/create")
  // public ResponseEntity<?> createUpdateSubCategory(@RequestBody SubCategory
  // sub) {
  ...
  public ResponseEntity<?> createCategory(
    ...
    return new ResponseEntity<>(
        responseData.jsonSimpleResponse("SUCCESS", "Successfuly " + action, action, catService.addCategory(sub)),
        action == "CREATE" ? HttpStatus.CREATED : HttpStatus.OK);
  ...
  public ResponseEntity<?> changePassword(@RequestBody User user, Principal principal) {
    ...
    try {
      return new ResponseEntity<>(
          responseData.jsonSimpleResponse("SUCCESS", "Successfuly Update", "UPDATE",
              userService.updatePassword(user, user.getId())),
          HttpStatus.OK);
  ...
  public ResponseEntity<?> createUpdateBlog(@PathVariable("userid") Integer userid, @RequestBody Blog b) {
    ...
    try {
      if (b.getId() > 0) {
        return new ResponseEntity<>(
            responseData.jsonSimpleBlogResponse("SUCCESS", "Successfuly Update", "UPDATE",
                blogService.updateBlogs(b, b.getId())),
            HttpStatus.OK);
      }
      return new ResponseEntity<>(
  ...
  public ResponseEntity<?> createUpdateProduct(
    ...
    ProductDTO p = ProductDTO.builder()
        ...
        .taxRate(Double.parseDouble(taxRate))
        .discount(Double.parseDouble(discount))
        .build();
    // try {
    // ProductDTO p=new ProductDTO.builder()
  ...
  @PostMapping("/Upload")
  public ResponseEntity<?> uploadFile(@RequestParam("subList") String subList,
      @RequestParam("catList") String catList) {
